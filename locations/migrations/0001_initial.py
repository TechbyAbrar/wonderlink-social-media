    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(db_index=True, help_text="Full name of the continent, e.g. 'Europe', 'Asia'.", max_length=100, unique=True)),
                ('population', models.BigIntegerField(blank=True, help_text='Optional population of the continent', null=True)),
                ('area_sq_km', models.BigIntegerField(blank=True, help_text='Total land area in square kilometers', null=True)),
            ],
            options={
